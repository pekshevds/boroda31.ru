"""
Django settings for boroda31 project.
...
ALLOWED_HOSTS = ['boroda31.ru', 'www.boroda31.ru', 'localhost',]
...
WSGI_APPLICATION = 'boroda31.wsgi.application'
